...
interface MatchTableProps {
  ...
  /*
   * Kept for compatibility with the main file.
   * Not used by this table.
   */
...
export interface MatchTableRef {
  /*
   * Focus first Br. ID
   */
  focusFirstBrId: () => void;
  ...
  /*
   * Compatibility with existing main file.
   * Can be removed later if not needed.
   */
  focusFirstAccountId: () => void;

  /*
   * Focus any field in any row
   */
  focusField: (
    rowIndex: number,
    field: TableField
